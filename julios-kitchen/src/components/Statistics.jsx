...
export default function Statistics(props) {	
  ...
  for (let i = 0; i < individuals.length; i++){
    if (individuals[i] === "Guacamole") { guacamoleCounter++ }
    else if (individuals[i] === "Argentinian Beef Empanadas") { empanadasCounter++ }
    else if (individuals[i] === "Irish Beef Stew") { stewCounter++ }
    else if (individuals[i] === "Blueberry Creme Brûlée") { cremeBrûléeCounter++ }
    else if (individuals[i] === "Red Snapper Ceviche") { cevicheCounter++ }
    else if (individuals[i] === "Salmon with Garlic and Dijon") { salmonCounter++ }
    else if (individuals[i] === "Crispy Almond Fish") { fishCounter++ }
    else if (individuals[i] === "Mushroom Risotto") { risottoCounter++ }
    else if (individuals[i] === "Bandera Dominicana") { banderaCounter++ }
    else if (individuals[i] === "Arroz con Leche") { arrozConLecheCounter++ }
    else if (individuals[i] === "Strawberries Romanoff") { strawberriesCounter++ }
  }
